...
# Load station CSVs
station_files = {
    'Aasu': 'Aasu/Aasu_ALL_15min_data_cleaned.csv',
    'Poloa': 'Poloa/Poloa_ALL_15min_data_cleaned.csv',
    'Afono': 'Afono/Afono_ALL_15min_data_cleaned.csv',
    'Vaipito': 'Vaipito/Vaipito_ALL_15min_data_cleaned.csv',
}
...
# Load synoptic files
synoptic_files = [
    '/Users/lizamclatchy/ASCDP/NSTU.2022-12-31.csv',
    '/Users/lizamclatchy/ASCDP/SFGP6.2022-12-31.csv'
]
...
date_config = {
    ...
    ('Aasu', 'Rain_in_Tot'): {
        "cutoff": "2020-04-14 00:15:00",
        "start": "2020-04-14 00:15:00",
...
#df_train.to_csv("Aa/vaipito_SlrW_Avg_train.csv", index=False)
#df_pred.to_csv("Vaipito/vaipito_SlrW_Avg_pred.csv", index=False)