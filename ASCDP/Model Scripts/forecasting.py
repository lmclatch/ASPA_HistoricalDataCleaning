...
#I want to fill Aasu 1/29/18 14:45 to 4/22/18 4:00 (all data from Aasu is missing at this time)



### WORKFLOW ####
#Start with a station, analyze the "bad_data" .csv, start with the first column
#If column says ALL DATA, the most correlated weather station needs to be used for forecasting
#If column says a specific variable, run XGBoost to forecast 
# the missing data for the dates listed utilzing other variables in the same weather station
#First: i want to try both methods to forecast known data so we can run MAPE
