...
combined_df = pd.read_csv("/Users/lizamclatchy/ASCDP/Data Cleaning/Cleaned Model Input Data/train_aasu_WS_mph_S_WVT.csv")
...
#max_lag = 7  # your largest lag/rolling window
#rh_data = rh_data.iloc[max_lag:].reset_index(drop=True)
...
out_path = "/Users/lizamclatchy/ASCDP/Results Analysis/WS_mph_S_WVT_aasu_model_error_metrics.csv"
