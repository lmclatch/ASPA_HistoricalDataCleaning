...
combined_df = pd.read_csv("/Users/lizamclatchy/Documents/GitHub/ASPA_HistoricalDataCleaning/ASCDP/Data Cleaning/Cleaned Model Input Data/vaipito_SlrMJ_Tot_train.csv")
...
rh_data = rh_data.dropna(subset=['SlrMJ_Tot_Vaipito'])  # Keep only rows where is not NaN
...
out_path = "/Users/lizamclatchy/Documents/GitHub/ASPA_HistoricalDataCleaning/ASCDP/Results Analysis/SlrMJ_Tot_Vaipito_error_metrics.csv"
...
import joblib
joblib.dump(model_xgb, 'SlrMJ_Tot_Vaipito_model_xgb.pkl')
joblib.dump(model_lgbm, 'SlrMJ_Tot_Vaipito_model_lgbm.pkl')
joblib.dump(stack, 'SlrMJ_Tot_Vaipito_stack.pkl')
