...
import joblib
joblib.dump(model_xgb, 'AirTF_Avg_Aasu_model_xgb.pkl')
joblib.dump(model_lgbm, 'AirTF_Avg_Aasu_model_lgbm.pkl')
joblib.dump(stack, 'AirTF_Avg_Aasu_stack.pkl')
...
TITLE = "Average Air Temperature of Aasu (C)"
