...
import joblib
joblib.dump(model_xgb, 'Rain_in_Tot_Aasu_model_xgb.pkl')
joblib.dump(model_lgbm, 'Rain_in_Tot_Aasu_model_lgbm.pkl')
joblib.dump(stack, 'Rain_in_Tot_Aasu_stack.pkl')
